...
def print_cafe_mug():
    print('\n'.join(["\t\t   _ _ _",
                     ...
                     "\t\t=== PCIServicesCAFE ==="]))
    print("========================================================")
    print("PCIServicesCAFE Framework installed")
    print("========================================================")
...
setup(
    name='pciservicescafe',
    version='0.0.1',
    description=(
        'PCIServicesCAFE is an implementation of the Open CAFE Framework '
        'specifically designed to test APIs'),
    long_description='{0}\n\n{1}'.format(
        open('README.md').read(),
